...
First, register for a Docker Hub account at [hub.docker.com/signup](hub.docker.com/signup), and
...
Unzip the folder and open up a new window of VS Code. Click "Open..." and navigate to the folder called "student-env-test-main". Click "open".
