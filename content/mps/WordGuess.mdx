...
Download the starter files onto your computer by visiting this link, [Starter Code](https://github.com/CS-128-Live/student-word-guess/archive/refs/heads/main.zip)
Unzip the folder with the starter files and open up a new window of VS Code. Click "Open..." and navigate to the folder called "student-word-guess-main". Click "open".
