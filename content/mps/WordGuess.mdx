...
[Starter Code](https://github.com/CS-128-Live/student-word-guess/archive/refs/heads/main.zip)

Start up the docker container from the docker app. Unzip the folder and open up a new window of VS Code. Click "Open..." and navigate to the folder called "student-word-guess-main". Click "open".
See [setup instructions](https://www.cs128live.org/course-book/resource/Setup)

When you are done with each part, submit on Prairie Learn via the autograder,

[Autograder](https://us.prairielearn.com/pl/course_instance/153040/assessment/2436440)
...
3.  Work on Part 1 - 30pts (Due Thursday Sep 12th at 11:59pm) (10 point reduction if submitted within 24 hours late)
...
4.  Work on Part 2 - 50pts (Due Thursday Sep 19th at 11:59pm) (10 point reduction if submitted within 24 hours late)
