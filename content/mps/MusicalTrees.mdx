...
the genetic algorithm. This part is more involved than Part 1 and will most likely take significantly more time. Please plan accordingly!
...
When and for debugging, I recommend writing and calling a function to check the invariants (as much as possible) at the end of every member function. This will alert you to bugs immediately. 
