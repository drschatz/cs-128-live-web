...
---
## Important Dates
Part 1 Due Date: Thursday 10/10 at 11:59pm (10 points)

Part 2 Due Date: Thursday 10/17 at 11:59pm (10 points)

Part 3 Due Date: Thursday 10/24 at 11:59pm (90 points)
...
In this MP you will create code that reads in an image file and a desired width and height. Note the new desired witdth and height needs to be the same
...
of the `Image` class and call various function you defined in `image_processing.cc` to seam carve the image.

This project is split into three parts across three weeks.

<b>Part 1</b> has you implement and test the `Image` class as well as the `RotateLeft` and `RotateRight` functions in `image_processing.cc`. 10pts (Due Thursday 10/10 at 11:59pm) (10% point reduction if submitted within 24 hours late)

<b>Part 2</b> has you implement and test the rest of the functions in `image_processing.cc`. 10pts (Due Thursday 10/17 at 11:59pm) (10% point reduction if submitted within 24 hours late) 

<b>Part 3</b> has you implement the driver for the program. 90pts (Due Thursday 10/24 at 11:59pm) (10% point reduction if submitted within 24 hours late)
