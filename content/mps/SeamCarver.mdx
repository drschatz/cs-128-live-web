...
At the end, you will have a vector the size of the height of the image. Each element indicates which column the pixel of the seam is in for that row. For example, if the 1st element
...
1. If the file cannot be opened, print "File could not be opened." with a newline and end the program.
2. If the width is bigger than the original image, print "Width is too big. We cannot currently grow the image." with a newline and end the program.
3. If the height is bigger than the original image, print "Height is too big. We cannot currently grow the image." with a newline and end the program.
...
If there are the wrong number of command line arguments, you should print "The format is, <image_name> <new_width> <new_height>"  with a newline and end the program.
